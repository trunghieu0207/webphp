...
<head>
  <meta charset="utf-8">
    ...
    <title>VoiceX Admin - Under maintenance </title>
...
<body class="hold-transition theme-fruit bg-img" style="background-image: url(../../images/auth-bg/bg-12.jpg);">
			...
			<div class="col-lg-4 col-12 h-lg-p100 h-auto bg-img" style="background-image: url(../../images/auth-bg/bg-1.jpg);">
				<div class="row l-block p-xl-100 p-lg-50 p-30 h-lg-p100 h-auto">
					...
					<div class="col-12 align-self-center">
						<h1 class="title text-white">Welcome to Voice!</h1>
						<h3 class="subtitle text-white-50">The ultimate Bootstrap &amp; admin theme framework for next generation web apps.</h3>
					</div>
